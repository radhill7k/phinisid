...
class phinisidApp(App):
    ...
    def __init__(self, language, **kwargs):
        ...
        super(phinisidApp, self).__init__(**kwargs)
    ...
    def on_pause(self):
        ...
        :class:`phinisidApp` to wait until the user
    ...
    def on_resume(self):
        ...
        stored in :meth:`phinisidApp.on_pause`.
        """
        pass
    ...
    def switch_lang(self, language):
        ...
        locales = gettext.translation(
            'phinisid', locale_dir, languages=[self.language]
        )
